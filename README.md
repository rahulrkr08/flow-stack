...
| Package | Description |
|---------|-------------|
| [@workflow-stack/core](./packages/core) | Core orchestration engine with built-in `custom` service type |
| [@workflow-stack/rest](./packages/rest) | REST/HTTP plugin using Undici |
...
npm install @workflow-stack/core
...
npm test --workspace=@workflow-stack/core
npm test --workspace=@workflow-stack/rest
```

## Documentation

- [@workflow-stack/core README](./packages/core/README.md) - Full API documentation
- [@workflow-stack/rest README](./packages/rest/README.md) - REST plugin documentation
