...
REST/HTTP plugin for @flow-stack/core - HTTP service orchestration using Undici.
...
```typescript
import type { RestServiceConfig } from '@flow-stack/rest';
import { restPlugin, executeRestService } from '@flow-stack/rest';
```
