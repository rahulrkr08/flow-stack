/**
 * @flow-stack/rest Plugin Example
 *
 * This example demonstrates using the REST plugin with @flow-stack/core
...
// Run orchestration
async function main() {
  console.log('Running @flow-stack/core with @flow-stack/rest plugin...\n');
